...
// after a batch is created called to make associated product
const createProductForBatch = async (batchId) => {
  const ProductID = await generateId("PROD", "Product");
  return await Product.create({ ProductID, PBatchID: batchId });
};

module.exports = { getProductByQR, createProductForBatch };
